...
who do not want to open their own code. See [LICENSING.en.md](LICENSING.en.md) for
details. For commercial inquiries: bintocher@yandex.com.

## Contributing

See [CONTRIBUTING.en.md](CONTRIBUTING.en.md). Contributions are accepted under
[CLA.en.md](CLA.en.md).

## Security

See [SECURITY.en.md](SECURITY.en.md) for how to report vulnerabilities.

## Support

The project is free and open source. [Support development](DONATE.en.md).
