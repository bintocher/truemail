...
function setCalendarSidebarOpen(open){document.getElementById('calSection').classList.toggle('sidebar-open',open);calSidebarToggle.setAttribute('aria-expanded',String(open));calSidebarToggle.title=open?L('Скрыть календари','Hide calendars'):L('Показать календари','Show calendars');localStorage.setItem('calendar_sidebar_open',open?'1':'0');}
