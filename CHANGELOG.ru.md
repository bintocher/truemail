...
- Windows-инсталлятор при ручном запуске поверх старой версии показывал
  страницу "Already Installed" с предложением удалить программу. Теперь
  обновление ставится сразу, как это делает встроенный апдейтер; страница
  осталась только для переустановки той же версии и отката на старую.

### Изменено

- Версия tauri-cli в CI зафиксирована (2.11.4), NSIS-шаблон вендорен.
