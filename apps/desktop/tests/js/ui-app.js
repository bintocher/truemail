...
// (fake-dom.js): эта поднимает запуск интерфейса с заданными данными ядра и ответами команд по имени;
// вторая - ui-window.js. Поведение узлов и событий у них общее, поэтому правка
