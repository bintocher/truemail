...
-- Стадия правил сверяет условия по снимку письма и этот индекс не использует.
-- Он нужен отбору писем запросом в задачах списков отправителей и автоочистки
-- по отправителю (specs/blocked-senders.md, specs/sweep-by-sender.md).
