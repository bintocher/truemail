...
function renderAccountSettings(accounts,foldersByAccount,calendars){
  ...
  if(accountCards.isOAuthAccount(account.auth_kind)){
    ...
    explanation.className='account-oauth-explanation';
    explanation.textContent=wt('accountOauthPasswordNotStored');
    reconnect.after(explanation);
  }
